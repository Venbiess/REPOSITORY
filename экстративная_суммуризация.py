# -*- coding: utf-8 -*-
"""Экстративная суммуризация.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JPClpxf8pCBPtJ9C4AxprriS7R1KdkHj
"""
...
f = open('/content/drive/My Drive/БД/180/model.txt', encoding='utf-8')
for line in f:
    values = line.split()
    word = values[0]
...
def text_process(text):
    ...
    import math
    if (len(sentences) > 2):
      sn = math.ceil(0.5*len(sentences))
    else:
      sn = 1
    ranked_output = []
    # Создание пересказа.
